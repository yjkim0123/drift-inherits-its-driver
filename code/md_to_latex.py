...
TABLES = [
    ...
    ("tab:contemp", r"Hospital transfer versus contemporaneous training. Arm A "
     ...
     r"concept drift."),
    ("tab:regimedist", r"Unlabeled regime distance against realized degradation, "
     r"2019--2023. The monitor's loudest reading is 2020, the year the model was "
     r"intact."),
    ...
    ("tab:residual", r"Residual signs at the solar peak and the evening ramp. The "
     r"direction of each shift was committed to in advance by the solar "
     r"hypothesis."),
